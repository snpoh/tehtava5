...
<form id="tiedot">
	...
	<input type="hidden" name="vanhattiedot" id="vanhattiedot">
</form>
<span id="ilmo"></span>
</body>
<script>
$(document).ready(function(){
	...
	//Haetaan muutettavan asiakkaan tiedot. Kutsutaan GET-metodia
	var asiakasid= requestURLParam("asiakasid");
	$.ajax({url:"asiakkaat/haeyksi/"+rekno, type:"GET", dataType:"json", success:function(result){
